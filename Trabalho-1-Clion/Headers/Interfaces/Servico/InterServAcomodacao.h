...
public:
    ...
    virtual void cadastrar(const Identificador& identificadorAcomodacao, const Tipo_Acomodacao& tipoAcomodacao, const Capacidade_De_Acomodacao& capacidadeDeAcomodacao, const Diaria& diaria, const Nome& cidade, const Estado& estado) = 0;

    //Cadastra uma nova disponibilidade em uma acomodacao pelo seu identificador
    virtual void cadastrarDisponibilidade(const Identificador& identificadorAcomodacao, const Data& dataInicio, const Data& dataTermino) = 0;

    //recebe o identificador da acomodacao e descadastra ela, caso seja possivel.
    virtual void descadastrar(const Identificador& identificadorAcomodacao) = 0;
    ...
    virtual void editar(const Identificador& identificadorAcomodacao, const Acomodacao& acomodacao) = 0;
